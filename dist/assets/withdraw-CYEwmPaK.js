import{a as I}from"./auth-IGyDQ3pF.js";import{a as P}from"./reset-3f-UIG5W.js";import{N as $,c as W}from"./Navbar-CJU9E0Tv.js";import{s as c}from"./supabaseClients-BL8TJKO9.js";import{t as h}from"./toastify-C88f8oFV.js";import{s as i}from"./spinner-DaVCJ9xF.js";import{M as g}from"./Modal-jvk0lnFM.js";import{l as y}from"./index-DJYm-znp.js";import{t as F}from"./analtics-D3HxoDr9.js";import"./logo-9_xFcp4C.js";import"./webAuthnHelper-CFOYufXH.js";import"./user-BBhvX4PB.js";const R=async()=>{if(!await I.check("withdraw"))return{html:"",pageEvents:()=>{}};P("Olymp AI | Withdraw Assets"),await F();const{html:x,pageEvents:v}=$();let n=[],s=null,r=0,w="",m="",l=!1;async function k(){try{i.start();const{data:{session:t},error:e}=await c.auth.getSession();if(e||!t)throw new Error("Authentication failed. Please login again.");const{data:a,error:o}=await c.from("user_assets").select(`
                *,
                assets:asset_id (
                    id,
                    symbol,
...
//# sourceMappingURL=withdraw-CYEwmPaK.js.map
