import{a as f,b}from"./reset-3f-UIG5W.js";import{A as v,S as g}from"./Navbar-CR-D7Ce9.js";import{l as y}from"./adminLoginHandler-D0WRBhIu.js";import{l as w}from"./index-BXoOFHK0.js";import{t as x}from"./toastify-C88f8oFV.js";import{s as m}from"./supabaseClients-Fr4pJEim.js";import{M as C}from"./Modal-jvk0lnFM.js";import"./index-BipRJY6b.js";import"./logo-9_xFcp4C.js";const A=()=>{async function n(){try{const r=await(await fetch("https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,tether,binancecoin&vs_currencies=usd")).json();return{BTC:r.bitcoin.usd,ETH:r.ethereum.usd,USDT:r.tether.usd,BNB:r.binancecoin.usd}}catch{return x({text:"Failed to fetch current prices",background:"bg-red-500"}),{}}}async function d(){try{const i=await n(),r=document.getElementById("cryptoPrices");if(!r)return;r.innerHTML="",Object.entries(i).forEach(([t,s])=>{const a=Math.random()*5-2.5,c=document.createElement("div");c.className="flex items-center justify-between p-4 bg-brand-black/30 rounded-xl border border-brand-primary/10",c.innerHTML=`
...
//# sourceMappingURL=dashboard-BVnwPHY-.js.map
