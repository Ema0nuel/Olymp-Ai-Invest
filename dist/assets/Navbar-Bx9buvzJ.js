import{a as c,b as E}from"./auth-S8CH6sXT.js";import{s as u}from"./supabaseClients-Fr4pJEim.js";import{p as x,l as y}from"./index-BXoOFHK0.js";import{L as z}from"./logo-9_xFcp4C.js";import{A as k}from"./user-BBhvX4PB.js";async function N(){try{const{data:{session:i},error:r}=await u.auth.getSession();if(r||!i)throw new Error("Not authenticated");const e=i.user.id,{data:n,error:a}=await u.from("notifications").select(`
                id,
                title,
                message,
                type,
...
//# sourceMappingURL=Navbar-Bx9buvzJ.js.map
