import{a as D}from"./auth-DqjBu9rB.js";import{a as A}from"./reset-3f-UIG5W.js";import{N as L}from"./Navbar-Bgx_mqpu.js";import{s as e}from"./supabaseClients-CP3flIu-.js";import{t as d}from"./toastify-C88f8oFV.js";import{M as p}from"./Modal-jvk0lnFM.js";import{s}from"./spinner-DaVCJ9xF.js";import{l as B}from"./index-U9ehfUVP.js";import{E as j,B as q}from"./eth-DaSwGu82.js";import{B as m,S as E}from"./sol-CRd287EW.js";import{t as C}from"./analtics-DgXkwIat.js";import"./logo-9_xFcp4C.js";import"./webAuthnHelper-CFOYufXH.js";import"./user-BBhvX4PB.js";const R={BTC:q,ETH:j,BNB:m,SOL:E,USDT:m},X=async()=>{if(!await D.check("wallet"))return{html:"",pageEvents:()=>{}};A("Olymp AI | Manage Wallet"),await C();const{html:g,pageEvents:x}=L(),{data:{user:i}}=await e.auth.getUser(),[b,w,y,f]=await Promise.all([e.from("trading_accounts").select("balance").eq("user_id",i.id).eq("account_type","live").single(),e.from("user_assets").select(`
                balance,
                assets (
                    symbol,
                    name,
...
//# sourceMappingURL=wallet-B0FMsT-3.js.map
