import{s}from"./supabaseClients-BL8TJKO9.js";import{l as y}from"./index-DJYm-znp.js";import{M as f}from"./Modal-jvk0lnFM.js";import{W as w}from"./621506e9a1183737fff2f2b8_NFT's _ Metaverse-CtPoGJaq.js";import{s as v}from"./send-email-89Z52C2k.js";import{i as _,r as I}from"./webAuthnHelper-CFOYufXH.js";const n=({text:t="",background:r="bg-brand-blue/10",color:a="text-white",icon:o="",duration:i=5e3})=>{document.querySelectorAll(".olymp-toast").forEach(l=>l.remove());const e=document.createElement("div");return e.className=`olymp-toast fixed top-8 right-8 z-[999999] px-6 py-4 rounded-xl 
...
//# sourceMappingURL=signupHandler-sMtU2jRD.js.map
