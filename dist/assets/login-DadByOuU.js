import{L as m}from"./logo-9_xFcp4C.js";import{a as p,b as u}from"./reset-3f-UIG5W.js";import{h as f,i as b}from"./Bannar-DeiwK6EK.js";import{a as g,l as d}from"./auth-DqjBu9rB.js";import{h as y}from"./signupHandler-Dao3kgf9.js";import{t as v}from"./analtics-DgXkwIat.js";import"./quote_bg-DFN30WNI.js";import"./spinner-DaVCJ9xF.js";import"./toastify-C88f8oFV.js";import"./supabaseClients-CP3flIu-.js";import"./index-U9ehfUVP.js";import"./webAuthnHelper-CFOYufXH.js";import"./Modal-jvk0lnFM.js";import"./621506e9a1183737fff2f2b8_NFT's _ Metaverse-CtPoGJaq.js";import"./send-email-89Z52C2k.js";const j=async()=>{if(!await g.check("login"))return{html:"",pageEvents:()=>{}};p("Login | Olymp AI Invest"),await v(),u();function c(){setTimeout(()=>b(),100);const r=document.getElementById("loginForm"),s=document.getElementById("email"),e=document.getElementById("password"),a=r?.querySelector('button[type="submit"]');s&&s.addEventListener("input",t=>{const o=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.target.value);s.style.borderColor=o?"":"rgb(239, 68, 68)"});const i=document.createElement("button");i.type="button",i.className="absolute right-4 bottom-0 -translate-y-1/2 text-gray-400 hover:text-white transition-colors",i.innerHTML='<i class="fas fa-eye"></i>',e&&(i.addEventListener("click",()=>{const t=e.type==="password"?"text":"password";e.type=t,i.innerHTML=t==="password"?'<i class="fas fa-eye"></i>':'<i class="fas fa-eye-slash"></i>'}),e.parentElement.style.position="relative",e.parentElement.appendChild(i)),r&&r.addEventListener("submit",async t=>{t.preventDefault(),a&&(a.disabled=!0,a.innerHTML=`
...
//# sourceMappingURL=login-DadByOuU.js.map
