import{a as c,b as E}from"./auth-IGyDQ3pF.js";import{s as u}from"./supabaseClients-BL8TJKO9.js";import{p as x,l as y}from"./index-DJYm-znp.js";import{L as z}from"./logo-9_xFcp4C.js";import{A as k}from"./user-BBhvX4PB.js";async function N(){try{const{data:{session:i},error:r}=await u.auth.getSession();if(r||!i)throw new Error("Not authenticated");const e=i.user.id,{data:n,error:a}=await u.from("notifications").select(`
                id,
                title,
                message,
                type,
...
//# sourceMappingURL=Navbar-CJU9E0Tv.js.map
