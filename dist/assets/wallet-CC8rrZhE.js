import{a as D}from"./auth-S8CH6sXT.js";import{a as A}from"./reset-3f-UIG5W.js";import{N as L}from"./Navbar-Bx9buvzJ.js";import{s as e}from"./supabaseClients-Fr4pJEim.js";import{t as d}from"./toastify-C88f8oFV.js";import{M as p}from"./Modal-jvk0lnFM.js";import{s}from"./spinner-DaVCJ9xF.js";import{l as B}from"./index-BXoOFHK0.js";import{S as j,E as q,B as E}from"./sol-CyENyCty.js";import{B as m}from"./bnb-DZcecBIT.js";import{t as C}from"./analtics-7M16VRr7.js";import"./logo-9_xFcp4C.js";import"./webAuthnHelper-CFOYufXH.js";import"./user-BBhvX4PB.js";const R={BTC:E,ETH:q,BNB:m,SOL:j,USDT:m},X=async()=>{if(!await D.check("wallet"))return{html:"",pageEvents:()=>{}};A("Olymp AI | Manage Wallet"),await C();const{html:g,pageEvents:x}=L(),{data:{user:i}}=await e.auth.getUser(),[b,w,y,f]=await Promise.all([e.from("trading_accounts").select("balance").eq("user_id",i.id).eq("account_type","live").single(),e.from("user_assets").select(`
                balance,
                assets (
                    symbol,
                    name,
...
//# sourceMappingURL=wallet-CC8rrZhE.js.map
