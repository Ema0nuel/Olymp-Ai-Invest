...
import Assets1 from '../../../images/assets/investor.png'
    ...
    function pageEvents() {
        ...
        if (form) {
            form.addEventListener("submit", async function (e) {
                ...
                form.reset()
                setTimeout(async () => await loadPage("home"), 2500)
            })
        }
    }
    ...
    return ({
        ...
        <section class="py-16 bg-brand-blue/5">
            <div class="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <img src="${Assets1}" alt="Contact" class="w-full rounded-2xl shadow-lg border-2 border-brand-primary/30">
                </div>
            </div>
        </section>
